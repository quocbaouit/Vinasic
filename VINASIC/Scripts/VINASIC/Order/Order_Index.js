                                        ...
                                        fields: {
                                            ...
                                            strDetailStatus: {
                                                ...
                                                display: function (data) {
                                                    ...
                                                    var text = $(' <div class="dropdown"><a class="dropdown-toggle" data-target="#" type="button" data-toggle="dropdown" href=\"javascript:void(0)\" class=\"clickable\" title=\"Chi tiết đơn hàng.\">' + strStatus +'</a></span></button><ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu"><li class="dropdown-submenu"><a tabindex="-1" href="#" class=" detailstatus1" href="javascript:void(0)">Chuyển cho thiết kế</a><ul class="dropdown-menu"><li><a href="#">Second level</a></li></ul></li><li class="dropdown-submenu"><a tabindex="-1" href="#" class=" detailstatus3" href="javascript:void(0)">Chuyển cho in ấn</a><ul class="dropdown-menu"><li><a href="#">Second level</a></li></ul></li><li class="dropdown-submenu"><a tabindex="-1" href="#" class=" detailstatus5" href="javascript:void(0)">chuyển cho gia công</a><ul class="dropdown-menu"><li><a href="#">Second level</a></li></ul></li><li class="dropdown-submenu"><a tabindex="-1" href="#" class=" detailstatus7" href="javascript:void(0)">Đã xong</a><ul class="dropdown-menu"><li><a href="#">Second level</a></li></ul></li></ul></div>');
                                                    text.click(function () {
