            ...
            fields: {
                ...
                ApprovalStatus: {
                    ...
                    display: function (data) {
                        ...
                        var text = $(' <div class="dropdown"><a class="dropdown-toggle" type="button" data-toggle="dropdown" href=\"javascript:void(0)\" class=\"clickable\" title=\"Cập nhật trạng thái đơn hàng.\">' + strStatus + '</a>' + "<ul class=\"dropdown-menu\"><li><a class=\"orderApproval\" data-id=\"1\" href=\"javascript:void(0)\">Yêu cầu sửa</a></li><li><a class=\"orderApproval\" data-id=\"2\" href=\"javascript:void(0)\">Yêu cầu xóa</a></li></ul>" + '</div>');
                        text.click(function (e) {
                            global.Data.IdOrderStatus = data.record.Id;
                        });
                        return text;
