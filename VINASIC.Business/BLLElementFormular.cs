...
namespace VINASIC.Business
{
    ...
    {
        private readonly IT_ElementFormularRepository _repElementFormular;
        private readonly IUnitOfWork<VINASICEntities> _unitOfWork;
        public BllElementFormular(IUnitOfWork<VINASICEntities> unitOfWork, IT_ElementFormularRepository repElementFormular)
        {
            _unitOfWork = unitOfWork;
            _repElementFormular = repElementFormular;
        }
