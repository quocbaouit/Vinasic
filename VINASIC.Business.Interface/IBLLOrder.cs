...
namespace VINASIC.Business.Interface
{
    public interface IBllOrder
    {
        ...
        ResponseBase UpdateDetailStatus(int detailId, int status, int employeeId,string content,string jobtype);
        ...
        ResponseBase UpdateOrderStatus(int orderId, int status,List<int> listIds, int userId, bool isAdmin, bool sendSMS = false, bool sendEmail = false);
        ResponseBase UpdateOrderDetailStatus(int orderId, int status, List<int> listIds, int userId, bool isAdmin, bool sendSMS = false, bool sendEmail = false);
